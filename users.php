...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/m1.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="logos/m1.jpg" alt="Bank" width="75" height="75">
        </h2>
    </class>
 ...
 <div class="container">
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" ><i>TRANSFER<i></button>
            </div>
        </form>
    </div>
